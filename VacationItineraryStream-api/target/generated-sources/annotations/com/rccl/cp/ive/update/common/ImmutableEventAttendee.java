...
public final class ImmutableEventAttendee implements EventAttendee {
  private final String cruiseReservationID;
  ...
  @Override
  public String cruiseReservationID() {
   ...
   */
  public final ImmutableEventAttendee withCruiseReservationID(String value) {
    if (this.cruiseReservationID.equals(value)) return this;
    String newValue = Preconditions.checkNotNull(value, "cruiseReservationID");
   ...
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableEventAttendee withGuestID(String value) {
  ...
  static final class Json implements EventAttendee {
    @Nullable String cruiseReservationID;
    @Nullable String guestID;
    @Nullable String sailingID;
    @Nullable String firstName;
    @Nullable String lastName;
    @JsonProperty("cruiseReservationID")
    public void setCruiseReservationID(String cruiseReservationID) {
      this.cruiseReservationID = cruiseReservationID;
    }
    @JsonProperty("guestID")
    ...
    @Override
    public String cruiseReservationID() { throw new UnsupportedOperationException(); }
    @Override
  ...
  public static final class Builder {
    ...
    private @Nullable String cruiseReservationID;
     ...
     */
    @JsonProperty("cruiseReservationID")
    public final Builder cruiseReservationID(String cruiseReservationID) {
