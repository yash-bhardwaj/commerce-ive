...
@Value.Immutable
@JsonSerialize(as = ImmutableCruiseCompassEventMessage.class)
@JsonDeserialize(as = ImmutableCruiseCompassEventMessage.class)
public interface CruiseCompassEventMessage extends BasicMessage {
    @Override
