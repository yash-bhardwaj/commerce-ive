...
import com.rccl.cp.ive.update.readside.po.ReadsideGuestCalendarEventPersistorDefaultImpl;
...
public class IVEUpdateModule extends AbstractModule
    ...
    protected final void configure() {
        ...
        bind(ReadsideGuestCalendarPersistor.class)
            ...
            .to(ReadsideGuestCalendarEventPersistorDefaultImpl.class);
        bind(ReadsideGuestCalendarPersistor.class)
            .to(ReadsideGuestCalendarEventPersistorDefaultImpl.class);
